...
<nav class="bottom-nav">
  <a href="/" class:active={$page.url.pathname === '/'}>🏠 Lakay</a>
  <a href="/matches" class:active={$page.url.pathname === '/matches'}>⚽ Match</a>
  <a href="/gallery" class:active={$page.url.pathname.startsWith('/gallery')}>📸 Galeri</a>
  <a href="/ville" class:active={$page.url.pathname === '/ville'}>🏙️ Vil</a>
  <a href="/map" class:active={$page.url.pathname === '/map'}>🗺️ Kat</a>
</nav>
